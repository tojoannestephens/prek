...
const ROTATIONS = {
  instructional_innovators: [
    ...
    { time: "10:10–10:50 AM", session: "MagicSchool AI", location: "Mac Lab" },
    { time: "11:05–11:45 AM", session: "AI Policy & Cybersecurity", location: "Media Center" },
  ...
  learning_architects: [
    { time: "7:30–8:30 AM", session: "Line Dancing, Exercising, Music, Entertainment, and Group Selection", location: "Gym" },
    { time: "8:30–9:00 AM", session: "Keynote: Dr. Mark Sullivan", location: "Cafeteria" },
    { time: "9:15–9:55 AM", session: "AI Policy & Cybersecurity", location: "Media Center" },
    ...
    { time: "11:45 AM–1:15 PM", session: "Lunch", location: "Cafeteria" },
    { time: "1:30–2:10 PM", session: "MagicSchool AI", location: "Mac Lab" },
  ],
  digital_designers: [
    { time: "7:30–8:30 AM", session: "Line Dancing, Exercising, Music, Entertainment, and Group Selection", location: "Gym" },
    { time: "8:30–9:00 AM", session: "Keynote: Dr. Mark Sullivan", location: "Cafeteria" },
    { time: "9:15–9:55 AM", session: "MagicSchool AI", location: "Mac Lab" },
    { time: "10:10–10:50 AM", session: "AI Policy & Cybersecurity", location: "Media Center" },
  ...
  integration_engineers: [
    ...
    { time: "11:05–11:45 AM", session: "MagicSchool AI", location: "Mac Lab" },
    { time: "11:45 AM–1:15 PM", session: "Lunch", location: "Cafeteria" },
    { time: "1:30–2:10 PM", session: "AI Policy & Cybersecurity", location: "Media Center" },
  ],
};
